...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-background">
      {/* Mobile: фото сверху; desktop: full-bleed */}
      ...
      {/* Mobile: контент-панель с читаемым текстом; desktop: поверх фона */}
      <div className="relative z-10 pb-16 sm:pb-20 lg:mx-auto lg:max-w-7xl lg:px-10 lg:pb-24 lg:pt-16">
        <div className="hero-content-sheet">
          <div className="mx-auto max-w-3xl px-4 pt-7 sm:px-6 sm:pt-8 lg:px-0 lg:pt-0">
          <motion.p
